...
{
  currentUser: any; 
apiRoot: string = 'http://mynewservicesumit.azurewebsites.net/api/Token';
  ...
  //}
    */  
    ...
    // console.log(credentials);
     let _InstUrl = "http://mynewservicesumit.azurewebsites.net/api/Token?username="+user+"&password="+password+""; 
